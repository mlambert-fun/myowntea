    ...
    <Layout>
      <div className="admin-page admin-page-premium-lite">
        <div className="admin-header">
          <div>
            <h1 className="admin-title">Expéditions</h1>
            <p className="admin-subtitle">Gestion des envois et étiquettes Boxtal</p>
          </div>
          <button
            ...
            <tbody>
              {shipments.map((shipment) => (
                <tr key={shipment.id}>
                  ...
                  <td>
                    {shipment.labelUrl ? (
                      <a className="admin-link-inline" href={shipment.labelUrl} target="_blank" rel="noreferrer">
                        Télécharger
                      </a>
                    ) : (
                      '—'
                  ...
                  <td>
                    <div style={{ display: 'flex', gap: '0.5rem' }}>
                      <button
                        ...
                        title="Rafraîchir l'étiquette"
                        aria-label={`Rafraîchir l'étiquette pour ${shipment.order?.orderNumber || 'cette expédition'}`}
                        onClick={async () => {
                      ...
                      >
                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" aria-hidden="true">
                          <path
                            d="M9 4h10a1 1 0 0 1 1 1v10l-6 6H5a1 1 0 0 1-1-1V9l5-5Z"
                            stroke="currentColor"
                            strokeWidth="1.5"
                      ...
                      <button
                        ...
                        aria-label={`Rafraîchir le suivi pour ${shipment.order?.orderNumber || 'cette expédition'}`}
                        onClick={async () => {
              ...
              {shipments.length === 0 && !loading && (
                <tr>
                  <td colSpan={7} className="admin-muted" style={{ textAlign: 'center' }}>
