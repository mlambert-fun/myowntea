        ...
        <div className="flex h-full flex-col">
          <div className="flex items-center justify-between px-6 py-5 border-b border-[#EEE6D8]">
            <div className="flex items-center gap-2">
              ...
              <h3 className="font-display text-xl text-[var(--sage-deep)]">Bonjour {customer?.firstName || customer?.email || 'Client'}</h3>
            </div>
            <button
              onClick={onClose}
          ...
          <div className="flex-1 overflow-y-auto px-6 py-6 space-y-4">
            <button
              className="w-full text-left px-4 py-3 rounded-xl border border-[#EEE6D8] hover:border-[var(--gold-antique)] transition-colors"
              onClick={() => {
            ...
            <button
              className="w-full text-left px-4 py-3 rounded-xl border border-[#EEE6D8] hover:border-[var(--gold-antique)] transition-colors text-[var(--gold-antique)]"
              onClick={async () => {
                onClose();
                await logout();
                navigate('/logout');
