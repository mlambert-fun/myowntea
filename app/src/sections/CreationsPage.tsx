...
const blendFormatShortLabelMap: Record<BlendFormatCode, string> = {
  POUCH_100G: 'POUCH',
  MUSLIN_20: 'MUSLIN',
};
      ...
      <section className="min-h-screen bg-[#FAF8F3] pt-28 pb-16">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="flex flex-col gap-2 mb-10">
            <h1 className="font-display text-4xl text-[var(--sage-deep)]">Créations de la communauté</h1>
            <p className="text-[var(--sage-deep)]/70 max-w-2xl">
              Découvrez les mélanges les plus inspirants, issus des commandes de la communauté. Ajoutez-les à votre panier et personnalisez-les ensuite.
            </p>
          </div>

          {loading ? (
            <DataLoadingState size="md" className="py-8" title="Chargement des créations..." titleClassName="text-[var(--sage-deep)]/70" />
          ) : listings.length === 0 ? (
            <div className="bg-white rounded-2xl p-6 text-[var(--sage-deep)]/70">Aucune création disponible pour le moment.</div>
          ) : (
                    ...
                    <div className="p-5">
                      ...
                      <div className="mt-4 flex items-center gap-3">
                        ...
                        <button
                          ...
                          onClick={(e) => {
                            e.stopPropagation();
                            const ingredientIds = orderedIngredients.map((entry: any) => entry.ingredientId || entry.ingredient?.id).filter(Boolean);
                ...
                {BLEND_FORMAT_OPTIONS.map((option) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      />
                      <span className="block text-sm font-medium text-[var(--sage-deep)]">
                        {blendFormatShortLabelMap[option.code]}
                      </span>
