        ...
        <div className="relative mx-auto max-w-3xl px-6">
          ...
          <div className="relative overflow-hidden rounded-2xl border border-[#EEE6D8] bg-white/90 p-10 shadow-xl">
            <div className="flex flex-col items-start gap-4">
              <span className="inline-flex items-center rounded-full bg-[var(--sage-deep)]/10 px-4 py-2 text-xs uppercase tracking-[0.22em] text-[var(--sage-deep)]">
                Session terminée
              </span>
              <h1 className="font-display text-3xl text-[var(--sage-deep)]">
                Vous êtes déconnecté(e)
              </h1>
              <p className="text-base text-[var(--sage-deep)]/70">
                Vous allez être redirigé(e) vers l&apos;accueil dans{' '}
              ...
              <button
                type="button"
                onClick={() => navigate('/')}
                className="mt-2 inline-flex items-center justify-center rounded-full border border-[var(--sage-deep)] px-5 py-2 text-sm font-medium text-[var(--sage-deep)] transition hover:border-[var(--gold-antique)] hover:text-[var(--gold-antique)]"
              >
